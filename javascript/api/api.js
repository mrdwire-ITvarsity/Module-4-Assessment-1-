    ...
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _convertPositionTo: function (c, f) {
            ...
            return {
                ...
                left: f.left + this.offset.relative.left * c + this.offset.parent.left * c - (b.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() :
                    e ? 0 : g.scrollLeft()) * c)
            }
        },
        _generatePosition: function (c) {
        ...
        _clear: function (c, f) {
            ...
            if (!b.ui.contains(this.element[0], this.currentItem[0])) {
                ...
                for (e = this.containers.length - 1; e >= 0; e--)
                    if (b.ui.contains(this.containers[e].element[0],
...
function init() {
    ...
    $("#eyes_01-draggable").draggable({
        drag: function () {
            $("#eyes_01-draggable").css("transform", "scale(1.3)");
        },

    });

    $("#eyes_02-draggable").draggable({
        drag: function () {
            $("#eyes_02-draggable").css("transform", "scale(1.3)");
        },

    });


    $("#eyes_03-draggable").draggable({
        drag: function () {
            $("#eyes_03-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_04-draggable").draggable({
        drag: function () {
            $("#eyes_04-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_05-draggable").draggable({
        drag: function () {
            $("#eyes_05-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_06-draggable").draggable({
        drag: function () {
            $("#eyes_06-draggable").css("transform", "scale(1.3)");
        },
    ...
    $("#eyes_07-draggable").draggable({
        drag: function () {
            $("#eyes_07-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_08-draggable").draggable({
        drag: function () {
            $("#eyes_08-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_09-draggable").draggable({
        drag: function () {
            $("#eyes_09-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_11-draggable").draggable({
        drag: function () {
            $("#eyes_11-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_12-draggable").draggable({
        drag: function () {
            $("#eyes_12-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_13-draggable").draggable({
        drag: function () {
            $("#eyes_13-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_14-draggable").draggable({
        drag: function () {
            $("#eyes_14-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_15-draggable").draggable({
        drag: function () {
            $("#eyes_15-draggable").css("transform", "scale(1.3)");
        },

    });
    $("#eyes_16-draggable").draggable({
        drag: function () {
            $("#eyes_16-draggable").css("transform", "scale(1.3)");
        },
    ...
    $("#figure-20-draggable").draggable({
        drag: function () {
            $("#figure-20-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-17-draggable").draggable({
        drag: function () {
            $("#figure-17-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-15-draggable").draggable({
        drag: function () {
            $("#figure-15-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-14-draggable ").draggable({
        drag: function () {
            $("#figure-14-draggable ").css("transform", "scale(1)");
        },

    });

    $("#figure-12-draggable").draggable({
        drag: function () {
            $("#figure-12-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-11-draggable").draggable({
        drag: function () {
            $("#figure-11-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-13-draggable").draggable({
        drag: function () {
            $("#figure-13-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-9-draggable").draggable({
        drag: function () {
            $("#figure-9-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-8-draggable").draggable({
        drag: function () {
            $("#figure-8-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-6-draggable").draggable({
        drag: function () {
            $("#figure-6-draggable").css("transform", "scale(1)");
        },

    });

    $("#figure-3-draggable").draggable({
        drag: function () {
            $("#figure-3-draggable").css("transform", "scale(1)");
        },
    ...
    $("#E-2-draggable").draggable({
        drag: function () {
            $("#E-2-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-3-draggable").draggable({
        drag: function () {
            $("#E-3-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-4-draggable").draggable({
        drag: function () {
            $("#E-4-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-5-draggable").draggable({
        drag: function () {
            $("#E-5-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-6-draggable").draggable({
        drag: function () {
            $("#E-6-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-7-draggable").draggable({
        drag: function () {
            $("#E-7-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-8-draggable").draggable({
        drag: function () {
            $("#E-8-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-9-draggable").draggable({
        drag: function () {
            $("#E-9-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-10-draggable").draggable({
        drag: function () {
            $("#E-10-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-11-draggable").draggable({
        drag: function () {
            $("#E-11-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-12-draggable").draggable({
        drag: function () {
            $("#E-12-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#E-13-draggable").draggable({
        drag: function () {
            $("#E-13-draggable").css("transform", "scale(0.5)");
        },
    ...
    $("#glasses-1-draggable").draggable({
        drag: function () {
            $("#glasses-1-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-2-draggable").draggable({
        drag: function () {
            $("#glasses-2-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-3-draggable").draggable({
        drag: function () {
            $("#glasses-3-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-4-draggable").draggable({
        drag: function () {
            $("#glasses-4-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-5-draggable").draggable({
        drag: function () {
            $("#glasses-5-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-6-draggable").draggable({
        drag: function () {
            $("#glasses-6-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-7-draggable").draggable({
        drag: function () {
            $("#glasses-7-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-8-draggable").draggable({
        drag: function () {
            $("#glasses-8-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-9-draggable").draggable({
        drag: function () {
            $("#glasses-9-draggable").css("transform", "scale(0.5)");
        },
    ...
    $("#glasses-10-draggable").draggable({
        drag: function () {
            $("#glasses-10-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-11-draggable").draggable({
        drag: function () {
            $("#glasses-11-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-12-draggable").draggable({
        drag: function () {
            $("#glasses-12-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-13-draggable").draggable({
        drag: function () {
            $("#glasses-13-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#glasses-14-draggable").draggable({
        drag: function () {
            $("#glasses-14-draggable").css("transform", "scale(0.5)");
        },
    ...
    $("#mouth_01-draggable ").draggable({
        drag: function () {
            $("#mouth_01-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_02-draggable ").draggable({
        drag: function () {
            $("#mouth_02-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_03-draggable ").draggable({
        drag: function () {
            $("#mouth_03-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_04-draggable ").draggable({
        drag: function () {
            $("#mouth_04-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_05-draggable ").draggable({
        drag: function () {
            $("#mouth_05-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_06-draggable ").draggable({
        drag: function () {
            $("#mouth_06-draggable ").css("transform", "scale(1)");
        },

    });


    $("#mouth_07-draggable ").draggable({
        drag: function () {
            $("#mouth_07-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_08-draggable ").draggable({
        drag: function () {
            $("#mouth_08-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_10-draggable ").draggable({
        drag: function () {
            $("#mouth_10-draggable ").css("transform", "scale(1)");
        },

    });
    $("#mouth_11-draggable ").draggable({
        drag: function () {
            $("#mouth_11-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_12-draggable ").draggable({
        drag: function () {
            $("#mouth_12-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_13-draggable ").draggable({
        drag: function () {
            $("#mouth_13-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_14-draggable ").draggable({
        drag: function () {
            $("#mouth_14-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_15-draggable ").draggable({
        drag: function () {
            $("#mouth_15-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_16-draggable ").draggable({
        drag: function () {
            $("#mouth_16-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_17-draggable ").draggable({
        drag: function () {
            $("#mouth_17-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_18-draggable ").draggable({
        drag: function () {
            $("#mouth_18-draggable ").css("transform", "scale(1)");
        },

    });

    $("#mouth_19-draggable ").draggable({
        drag: function () {
            $("#mouth_19-draggable ").css("transform", "scale(1)");
        },
    ...
    $("#face-hair_01-draggable").draggable({
        drag: function () {
            $("#face-hair_01-draggable").css("transform", "scale(1)");
        },

    });

    $("#face-hair_02-draggable").draggable({
        drag: function () {
            $("#face-hair_02-draggable").css("transform", "scale(1)");
        },

    });


    $("#face-hair_03-draggable").draggable({
        drag: function () {
            $("#face-hair_03-draggable").css("transform", "scale(1)");
        },

    });

    $("#face-hair_04-draggable").draggable({
        drag: function () {
            $("#face-hair_04-draggable").css("transform", "scale(1)");
        },

    });


    $("#face-hair_05-draggable").draggable({
        drag: function () {
            $("#face-hair_05-draggable").css("transform", "scale(1)");
        },

    });

    $("#face-hair_06-draggable").draggable({
        drag: function () {
            $("#face-hair_06-draggable").css("transform", "scale(1)");
        },

    });

    $("#face-hair_07-draggable").draggable({
        drag: function () {
            $("#face-hair_07-draggable").css("transform", "scale(1)");
        },
    ...
    /*HANDS-LEGS*/
    /*===================================================================================================================================*/
    $("#hand-1-draggable").draggable({
        drag: function () {
            $("#hand-1-draggable").css("transform", "scale(1)");
        },

    });

    $("#hand-2-draggable").draggable({
        drag: function () {
            $("#hand-2-draggable").css("transform", "scale(1)");
        },

    });

    $("#hand-3-draggable").draggable({
        drag: function () {
            $("#hand-3-draggable").css("transform", "scale(1)");
        },

    });


    $("#hand-4-draggable").draggable({
        drag: function () {
            $("#hand-4-draggable").css("transform", "scale(1)");
        },
    ...
    $("#hand-5-draggable").draggable({
        drag: function () {
            $("#hand-5-draggable").css("transform", "scale(1)");
        },

    });


    $("#hand-6-draggable").draggable({
        drag: function () {
            $("#hand-6-draggable").css("transform", "scale(1)");
        },

    });


    $("#hand-7-draggable").draggable({
        drag: function () {
            $("#hand-7-draggable").css("transform", "scale(1)");
        },

    });

    $("#hand-8-draggable").draggable({
        drag: function () {
            $("#hand-8-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-1-draggable").draggable({
        drag: function () {
            $("#L-1-draggable").css("transform", "scale(1)");
        },
    ...
    $("#L-2-draggable").draggable({
        drag: function () {
            $("#L-2-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-3-draggable").draggable({
        drag: function () {
            $("#L-3-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-4-draggable").draggable({
        drag: function () {
            $("#L-4-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-5-draggable").draggable({
        drag: function () {
            $("#L-5-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-6-draggable").draggable({
        drag: function () {
            $("#L-6-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-7-draggable").draggable({
        drag: function () {
            $("#L-7-draggable").css("transform", "scale(1)");
        },

    });

    $("#L-8-draggable").draggable({
        drag: function () {
            $("#L-8-draggable").css("transform", "scale(1)");
        },
    ...
    $("#burger-left-draggable").draggable({
        drag: function () {
            $("#burger-left-draggable").css("transform", "scale(0.4)");
        },

    });

    $("#burger-right-draggable ").draggable({
        drag: function () {
            $("#burger-right-draggable ").css("transform", "scale(0.4)");
        },

    });

    $("#clown-left-draggable").draggable({
        drag: function () {
            $("#clown-left-draggable").css("transform", "scale(0.4)");
        },

    });

    $("#clown-right-draggable").draggable({
        drag: function () {
            $("#clown-right-draggable").css("transform", "scale(0.4)");
        },

    });

    $("#left-shoes-1-draggable ").draggable({
        drag: function () {
            $("#left-shoes-1-draggable ").css("transform", "scale(0.6)");
        },

    });

    $("#right-shoes-1-draggable").draggable({
        drag: function () {
            $("#right-shoes-1-draggable").css("transform", "scale(0.6)");
        },

    });

    $("#shoe-right-draggable").draggable({
        drag: function () {
            $("#shoe-right-draggable").css("transform", "scale(0.7)");
        },

    });

    $("#shoe-left-draggable").draggable({
        drag: function () {
            $("#shoe-left-draggable").css("transform", "scale(0.7)");
        },

    });

    $("#sneak-left-1-draggable").draggable({
        drag: function () {
            $("#sneak-left-1-draggable").css("transform", "scale(0.8)");
        },

    });

    $("#sneak-right-1-draggable").draggable({
        drag: function () {
            $("#sneak-right-1-draggable").css("transform", "scale(0.8)");
        },

    });

    $("#sneak-left-2-draggable").draggable({
        drag: function () {
            $("#sneak-left-2-draggable").css("transform", "scale(0.8)");
        },

    });

    $("#sneak-right-2-draggable").draggable({
        drag: function () {
            $("#sneak-right-2-draggable").css("transform", "scale(0.8)");
        },

    });

    $("#takkie2-right-draggable").draggable({
        drag: function () {
            $("#takkie2-right-draggable").css("transform", "scale(0.6)");
        },

    });


    $("#takkie2-left-draggable ").draggable({
        drag: function () {
            $("#takkie2-left-draggable ").css("transform", "scale(0.6)");
        },

    });

    $("#takkie-left-draggable ").draggable({
        drag: function () {
            $("#takkie-left-draggable ").css("transform", "scale(0.7)");
        },

    });

    $("#takkie-right-draggable ").draggable({
        drag: function () {
            $("#takkie-right-draggable ").css("transform", "scale(0.7)");
        },
    ...
    $("#F-1-draggable").draggable({
        drag: function () {
            $("#F-1-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-2-draggable").draggable({
        drag: function () {
            $("#F-2-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-3-draggable").draggable({
        drag: function () {
            $("#F-3-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-4-draggable").draggable({
        drag: function () {
            $("#F-4-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-5-draggable").draggable({
        drag: function () {
            $("#F-5-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-6-draggable").draggable({
        drag: function () {
            $("#F-6-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-7-draggable").draggable({
        drag: function () {
            $("#F-7-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-8-draggable").draggable({
        drag: function () {
            $("#F-8-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-9-draggable").draggable({
        drag: function () {
            $("#F-9-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-10-draggable").draggable({
        drag: function () {
            $("#F-10-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-11-draggable").draggable({
        drag: function () {
            $("#F-11-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-13-draggable").draggable({
        drag: function () {
            $("#F-13-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-14-draggable").draggable({
        drag: function () {
            $("#F-14-draggable").css("transform", "scale(1)");
        },
    ...
    $("#F-15-draggable").draggable({
        drag: function () {
            $("#F-15-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-16-draggable").draggable({
        drag: function () {
            $("#F-16-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-17-draggable").draggable({
        drag: function () {
            $("#F-17-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-18-draggable").draggable({
        drag: function () {
            $("#F-18-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-19-draggable").draggable({
        drag: function () {
            $("#F-19-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-20-draggable").draggable({
        drag: function () {
            $("#F-20-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-21-draggable").draggable({
        drag: function () {
            $("#F-21-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-22-draggable").draggable({
        drag: function () {
            $("#F-22-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-23-draggable").draggable({
        drag: function () {
            $("#F-23-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-24-draggable").draggable({
        drag: function () {
            $("#F-24-draggable").css("transform", "scale(1)");
        },

    });

    $("#F-25-draggable").draggable({
        drag: function () {
            $("#F-25-draggable").css("transform", "scale(1)");
        },

    });
    $("#F-26-draggable").draggable({
        drag: function () {
            $("#F-26-draggable").css("transform", "scale(1)");
        },

    });
    $("#F-27-draggable").draggable({
        drag: function () {
            $("#F-27-draggable").css("transform", "scale(1)");
        },

    });
    $("#F-28-draggable").draggable({
        drag: function () {
            $("#F-28-draggable").css("transform", "scale(1)");
        },
    ...
    $("#C-1-draggable").draggable({
        drag: function () {
            $("#C-1-draggable").css("transform", "scale(0.5)");
        },

    });

    $("#C-2-draggable").draggable({
        drag: function () {
            $("#C-2-draggable").css("transform", "scale(0.7)");
        },

    });

    $("#C-3-draggable").draggable({
        drag: function () {
            $("#C-3-draggable").css("transform", "scale(0.7)");
        },

    });
    $("#C-4-draggable").draggable({
        drag: function () {
            $("#C-4-draggable").css("transform", "scale(0.7)");
        },

    });

    $("#C-5-draggable").draggable({
        drag: function () {
            $("#C-5-draggable").css("transform", "scale(1)");
        },

    });
    $("#C-6-draggable").draggable({
        drag: function () {
            $("#C-6-draggable").css("transform", "scale(1)");
        },

    });
    $("#C-7-draggable").draggable({
        drag: function () {
            $("#C-7-draggable").css("transform", "scale(1.2)");
        },

    });
    $("#C-8-draggable").draggable({
        drag: function () {
            $("#C-8-draggable").css("transform", "scale(1)");
        },

    });
    $("#C-9-draggable").draggable({
        drag: function () {
            $("#C-9-draggable").css("transform", "scale(1.2)");
        },

    });

    $("#C10-draggable ").draggable({
        drag: function () {
            $("#C10-draggable ").css("transform", "scale(1)");
        },

    });
    $("#pants_01-draggable ").draggable({
        drag: function () {
            $("#pants_01-draggable ").css("transform", "scale(1)");
        },

    });

    $("#pants_02-draggable").draggable({
        drag: function () {
            $("#pants_02-draggable").css("transform", "scale(1)");
        },

    });
    $("#pants_03-draggable ").draggable({
        drag: function () {
            $("#pants_03-draggable ").css("transform", "scale(1)");
        },

    });
    $("#pants_04-draggable").draggable({
        drag: function () {
            $("#pants_04-draggable").css("transform", "scale(1)");
        },

    });
    $("#pants_05-draggable").draggable({
        drag: function () {
            $("#pants_05-draggable").css("transform", "scale(1)");
        },

    });
    $("#shirt_01-draggable").draggable({
        drag: function () {
            $("#shirt_01-draggable").css("transform", "scale(1)");
        },

    });
    $("#shirt_02-draggable").draggable({
        drag: function () {
            $("#shirt_02-draggable").css("transform", "scale(1)");
        },

    });
    $("#shirt_03-draggable").draggable({
        drag: function () {
            $("#shirt_03-draggable").css("transform", "scale(1)");
        },

    });
    $("#shirt_04-draggable ").draggable({
        drag: function () {
            $("#shirt_04-draggable ").css("transform", "scale(1)");
        },

    });
    $("#shirt_05-draggable").draggable({
        drag: function () {
            $("#shirt_05-draggable").css("transform", "scale(1)");
        },
    ...
    $("#H-1-draggable").draggable({
        drag: function () {
            $("#H-1-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-2-draggable").draggable({
        drag: function () {
            $("#H-2-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-3-draggable").draggable({
        drag: function () {
            $("#H-3-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-4-draggable").draggable({
        drag: function () {
            $("#H-4-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-5-draggable").draggable({
        drag: function () {
            $("#H-5-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-6-draggable").draggable({
        drag: function () {
            $("#H-6-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-7-draggable").draggable({
        drag: function () {
            $("#H-7-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-8-draggable").draggable({
        drag: function () {
            $("#H-8-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-9-draggable").draggable({
        drag: function () {
            $("#H-9-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-10-draggable").draggable({
        drag: function () {
            $("#H-10-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-11-draggable").draggable({
        drag: function () {
            $("#H-11-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-11-draggable").draggable({
        drag: function () {
    ...
    $("#H-12-draggable").draggable({
        drag: function () {
            $("#H-12-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-13-draggable").draggable({
        drag: function () {
            $("#H-13-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-14-draggable").draggable({
        drag: function () {
            $("#H-14-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-15-draggable").draggable({
        drag: function () {
            $("#H-15-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-16-draggable").draggable({
        drag: function () {
            $("#H-16-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-17-draggable").draggable({
        drag: function () {
            $("#H-17-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-18-draggable").draggable({
        drag: function () {
            $("#H-18-draggable").css("transform", "scale(1)");
        },
    });
    $("#H-19-draggable").draggable({
        drag: function () {
            $("#H-19-draggable").css("transform", "scale(1)");
        },
    });
    ...
    $("#hat-1-draggable").draggable({
        drag: function () {
            $("#hat-1-draggable").css("transform", "scale(0.7)");
        },
    });
    $("#hat-2-draggable").draggable({
        drag: function () {
            $("#hat-2-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-3-draggable").draggable({
        drag: function () {
            $("#hat-3-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-4-draggable").draggable({
        drag: function () {
            $("#hat-4-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-5-draggable").draggable({
        drag: function () {
            $("#hat-5-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-6-draggable").draggable({
        drag: function () {
            $("#hat-6-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-7-draggable").draggable({
        drag: function () {
            $("#hat-7-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-8-draggable").draggable({
        drag: function () {
            $("#hat-8-draggable").css("transform", "scale(1)");
        },
    });
    $("#hat-9-draggable").draggable({
        drag: function () {
            $("#hat-9-draggable").css("transform", "scale(1)");
        },
    });
